...
namespace DeveloperTest.Business
{
    public class CustomerService : ICustomerService
    {
        ...
        {
            var addedCusomer = context.Customers.Add(new Customer
            {
                Name = model.Name,
                Type = model.Type
            });
            ...
            {
                CustomerId = addedCusomer.Entity.CustomerId,
                Name = addedCusomer.Entity.Name,
                Type = addedCusomer.Entity.Type
            };
        }
